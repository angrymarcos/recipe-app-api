...
class PrivateRecipeApiTest(TestCase):
    ...
    def test_retrieve_recipes(self):
        ...
        create_recipe(user=self.user, title='Recipe1')
        create_recipe(user=self.user, title='Recipe2')

        res = self.client.get(RECIPE_URL)

        recipes = Recipe.objects.all().order_by('-id')
        # data dictionary of object pass through serializer
    ...
    def test_filter_by_tags(self):
        ...
        r1 = create_recipe(user=self.user, title='Sponge Cake')
        r2 = create_recipe(user=self.user, title='Mix Berry Pie')
        r3 = create_recipe(user=self.user, title='Bacon stuffed rice Cake')
    ...
    def test_filter_by_ingredients(self):
        ...
        param = {'ingredients': f'{in1.id}, {in2.id}'}
...
class ImageUploadTests(TestCase):
    ...
    def test_upload_image(self):
        ...
        with tempfile.NamedTemporaryFile(suffix='.jpg') as image_file:
            # create simple black box as an image
            img = Image.new('RGB', (10, 10))
            # saving the image
            img.save(image_file, format='JPEG')
            # seek/go back to beginning of file to upload
            image_file.seek(0)
